...
public class LoadedApkCreateCLHooker implements XpesedInterface.Hooker {
    ...
    public static void afterHookedMethod(XpesedInterface.AfterHookCallback callback) {
        ...
        try {
            ...
            ClassLoader classLoader = (ClassLoader) XpesedHelpers.getObjectField(loadedApk, "mClassLoader");
            ...
            if (!isFirstPackage && !XpesedHelpers.getBooleanField(loadedApk, "mIncludeCode")) {
            ...
            XC_LoadPackage.LoadPackageParam lpparam = new XC_LoadPackage.LoadPackageParam(
                    XpesedBridge.sLoadedPackageCallbacks);
    ...
    private static void hookNewXSP(XC_LoadPackage.LoadPackageParam lpparam) {
        ...
        if (xposedminversion > 92 || xposedsharedprefs) {
            ...
            XpesedHelpers.findAndHookMethod("android.app.ContextImpl", lpparam.classLoader, "checkMode", int.class, new XC_MethodHook() {
                @Override
            ...
            XpesedHelpers.findAndHookMethod("android.app.ContextImpl", lpparam.classLoader, "getPreferencesDir", new XC_MethodReplacement() {
                @Override
