...
public class Main {
    ...
    public static void forkCommon(boolean isSystem, String niceName, String appDir, IBinder binder) { // 这是lsposed的入口类
        ...
        Utils.logI("Loading xpesed for " + niceName + "/" + Process.myUid());
