...
public final class ModuleUtil {
    ...
    public class InstalledModule {
        ...
        private InstalledModule(PackageInfo pkg, ZipFile modernModuleApk) {
            ...
            if (legacy) {
                Object minVersionRaw = app.metaData.get("xpesedminversion");
        ...
        public String getDescription() {
            ...
            if (legacy) {
                Object descriptionRaw = app.metaData.get("xpeseddescription");
        ...
        public List<String> getScopeList() {
            ...
            try {
                int scopeListResourceId = app.metaData.getInt("xpesedscope");
                if (scopeListResourceId != 0) {
                    list = Arrays.asList(pm.getResourcesForApplication(app).getStringArray(scopeListResourceId));
                } else {
                    String scopeListString = app.metaData.getString("xpesedscope");
            ...
            if (list != null) {
                ...
                //https://github.com/rovo89/XpesedBridge/commit/6b49688c929a7768f3113b4c65b429c7a7032afa
                list.replaceAll(s ->
                    switch (s) {
                        case "android" -> "system";
                        case "system" -> "android";
